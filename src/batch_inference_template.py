...
# Log environment info at startup to ensure everything is working
...
def model_fn(model_dir, context):
    try:
        ...
        logger.exception("Error in model_fn")
        raise
...
def input_fn(serialized_input_data, content_type=JSON_CONTENT_TYPE):
    ...
    try:
        ...
        logger.exception("Error in input_fn")
        raise
...
def predict_fn(input_object, model, context):
    try:
        with log_timing("Inference"):
            ...
            # Add a batch dimension and move to correct device if needed
        ...
        logger.exception("Error in predict_fn")
        raise
...
def output_fn(prediction_output, accept=JSON_CONTENT_TYPE):
    ...
    try:
        ...
        logger.exception("Error in output_fn")
        raise
